                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('coordinator/deleteseminar/'.$s['id_seminar']); ?>"
                                        class="badge badge-danger">delete</a>
                                    <a href="<?= base_url('coordinator/dataabsensi/'.$s['id_seminar']); ?>"
...
<div class="modal fade" id="newaddSeminar" tabindex="-1" role="dialog" aria-labelledby="newaddSeminar"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('coordinator/seminar'); ?>
...
<div class="modal fade" id="neweditSeminar<?= $id_seminar; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('coordinator/editseminar'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="tanggal_seminar" name="tanggal_seminar"
                            value="<?= $s['tanggal_seminar']; ?>" readonly>
                    </div>

                    <!-- <div class=" custom-file">
              <input type="file" class="custom-file-input" id="image" name="image" value="<?= $s['image']; ?>" placeholder="Image">
              <label class="custom-file-label" for="customFile">Choose file</label>
          </div> -->
