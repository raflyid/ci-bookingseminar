                    ...
                    <table class="table table-hover" id="table1" style="border: 1px solid rgb(200, 200, 200);">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="" class="badge badge-success" data-toggle="modal"
                                        data-target="#neweditStatus<?= $p['id_pembayaran'] ?>">Update
                                        Status</a><br><small><?= $p['status']; ?></small></td>
                                <?php }else {?>
                                ...
                                <td><?= $p['atas_nama'] ?></td>
                                <td>
                                    <a href="<?= base_url('admin/deletepembayaran/'.$p['id_pembayaran']); ?>"
...
<div class="modal fade" id="neweditStatus<?= $id_pembayaran; ?>" tabindex="-1" role="dialog"
    aria-labelledby="neweditStatus" aria-hidden="true">
            ...
            <form action="<?= base_url('admin/editstatus'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label ondragstart="return false;" for="inputstatus"
